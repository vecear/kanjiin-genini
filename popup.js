...
const TRANSLATIONS = {
    en: {
        ...
        modeAutoDesc: 'Auto-annotate using dictionary (for Japanese sites)',
        ...
        hotkeyTargetAuto: 'Auto (for Japanese sites)',
    ...
    ja: {
        ...
        modeAuto: '全漢字に自動ルビ',
        modeAutoDesc: '辞書で自動的にルビを付ける (日本語サイト向け)',
        hotkeyLabel: 'ルビ表示キー',
        hotkeyDisabled: '無効',
        hotkeyHold: '長押し',
        hotkeyToggle: '切替',
        ...
        hotkeyTargetAuto: '自動ルビ (日本語サイト向け)',
    ...
    ko: {
        ...
        modeAutoDesc: '사전으로 자동 표기 (일본어 사이트용)',
    ...
    es: {
        ...
        modeAutoDesc: 'Anotar automáticamente (para sitios japoneses)',
        ...
        hotkeyTargetAuto: 'Auto (para sitios japoneses)',
    ...
    pt: {
        ...
        modeAutoDesc: 'Anotar automaticamente (para sites japoneses)',
        hotkeyLabel: 'Tecla para mostrar',
        ...
        hotkeyTargetAuto: 'Auto (para sites japoneses)',
    ...
    fr: {
        ...
        modeAutoDesc: 'Annoter automatiquement (pour sites japonais)',
        ...
        hotkeyTargetAuto: 'Auto (pour sites japonais)',
    ...
    de: {
        ...
        modeAutoDesc: 'Automatisch annotieren (für japanische Seiten)',
        ...
        hotkeyTargetAuto: 'Auto (für japanische Seiten)',
    ...
    it: {
        ...
        modeAutoDesc: 'Annota automaticamente (per siti giapponesi)',
        ...
        hotkeyTargetAuto: 'Auto (per siti giapponesi)',
